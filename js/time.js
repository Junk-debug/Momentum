...
function showDate() {
  ...
  const currentDate =
    "dayFromNum" in translations[settings.language].time
      ? `${
          translations[settings.language].time.dayFromNum[date.getDay()]
        }, ${date.getDate()} ${
          translations[settings.language].time.monthFromNum[date.getMonth()]
        }`
